        ...
        <div className="container my-5">
            ...
            <div className="row mb-4">
                ...
                <div className="col-md-6">
                    <div className="caja-compra">
                        ...
                        <i className="fas fa-shopping-cart me-2"></i>AÑADIR AL CARRO
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className="row mb-4">
                <div className="col-12">
                    <div className="seccion-info">
                        <h5><i className="fas fa-info-circle me-2"></i>Descripción del Producto</h5>
            ...
            <div className="row mb-4">
                <div className="col-md-8">
                    <div className="comentarios-container">
                        <h5><i className="fas fa-comments me-2"></i>Opiniones de Clientes</h5>
            ...
            <div className="row mb-4">
                ...
                <div className="compartir-container">
                    <h5><i className="fas fa-share-alt me-2"></i>Compartir este producto</h5>
                    <div className="redes-sociales">
                    <a href="https://wa.me/?text=Mira estas naranjas: http://localhost:3000/productos/naranja" target="_blank" rel="noopener noreferrer" className="btn-red whatsapp">
                        <i className="fab fa-whatsapp"></i> WhatsApp
                    </a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u=http://localhost:3000/productos/naranja" target="_blank" rel="noopener noreferrer" className="btn-red facebook">
                        <i className="fab fa-facebook-f"></i> Facebook
                    </a>
                    <a href="https://twitter.com/intent/tweet?text=Mira estas naranjas&url=http://localhost:3000/productos/naranja" target="_blank" rel="noopener noreferrer" className="btn-red twitter">
