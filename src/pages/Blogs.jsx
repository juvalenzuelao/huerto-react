    ...
    <>
      ...
      <section className="py-5 bg-light">
        <div className="container text-center">
          <h1 className="display-4 fw-bold text-success mb-3">
            <i className="fa-solid fa-seedling me-3"></i>Noticias importantes
          </h1>
      ...
      <div className="container mt-5 containerInfo">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <img src="/img/PlatanoCavendish.png" alt="Plátano Cavendish hidropónico" className="logoBlog" loading="lazy" />
          </div>
        </div>
      </div>
      ...
      <div className="container mt-5 containerInfo">
        <div className="row align-items-center container-alternate">
          ...
          <div className="col-md-6">
            <img src="/img/blogs/sistemaIot.jpg" alt="Sistema IoT en huertos" className="logoBlog" loading="lazy" />
          </div>
        </div>
      </div>
      ...
      <div className="container mt-5 containerInfo">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <img src="/img/blogs/abejasMiel.jpg" alt="Abejas trabajando en el huerto" className="logoBlog" loading="lazy" />
          </div>
        </div>
      </div>
      ...
      <div className="container mt-5 containerInfo">
        <div className="row align-items-center container-alternate">
          ...
          <div className="col-md-6">
            <img src="/img/blogs/zanahoriasOrganicas.jpg" alt="Zanahorias orgánicas de Concepción" className="logoBlog" loading="lazy" />
          </div>
        </div>
      </div>
